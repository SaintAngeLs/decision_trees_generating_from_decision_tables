...
fakeNode.value = elem;
return avl_insert_impl(tree_root, &fakeNode, allocMem, sizeof(DataQueryKeyAvlNode2), comp, offsetof(DataQueryKeyAvlNode2, left),
...
DataQueryKeyAvlNode2 fakeNode;
fakeNode.value = elem;
return avl_erase_by_value_impl(tree_root, &fakeNode, sizeof(DataQueryKeyAvlNode2), comp, offsetof(DataQueryKeyAvlNode2, left),
  offsetof(DataQueryKeyAvlNode2, right), offsetof(DataQueryKeyAvlNode2, ht));
                        }
